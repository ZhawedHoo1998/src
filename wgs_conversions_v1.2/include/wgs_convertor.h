...
public:
    ...
    //CALLBAC
    void headingCallback(const geometry_msgs::QuaternionStampedConstPtr& msg);
...
public:
    ...
    // enu在odom下的位姿
    double enu_p_odom_x_;
    double enu_p_odom_y_;
    double enu_p_odom_z_;
    double enu_p_odom_yaw_;
    double enu_p_odom_pitch_;
    double enu_p_odom_roll_;
    double init_heading_;//初始的gps航向角
    double yaw_vehicle_;//当前车的角度

    // geometry_msgs::QuaternionStamped heading_msg_;

    geometry_msgs::TransformStamped tf;//odom在enu坐标系下的位姿
